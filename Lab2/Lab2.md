...
![Create kind cluster](Evidence/0-Create-Cluster.png)

![Install Calico](Evidence/0.1-Install-calico.png)
...
![Create tenants](Evidence/1-Create-Tenant.png)

![Deploy tenant web services](Evidence/1.2-Deploy-Web.png)
...
![Tenant B service IP](Evidence/2-TenantB-IP.png)

![Tenant A reaches Tenant B before policy](Evidence/2.1-a-tenant-b.png)
...
![Apply ResourceQuota](Evidence/3-ResourceQuota.png)

![Inspect ResourceQuota](Evidence/3.1-Inspect-RQ.png)
...
![Apply default-deny NetworkPolicy](Evidence/4-deny-ingress.png)
...
![Retest after NetworkPolicy](Evidence/4.1-check-network.png)
...
![Create tenant secrets](Evidence/5-secret.png)

![Create tenant-scoped RBAC](Evidence/5.1-scoped.png)

![Check RBAC authorization](Evidence/5.2-Check-Rolebinding.png)
...
![Normal delete and scan](Evidence/6-create-del.png)

![Secure wipe output](Evidence/6.1-Secure-wipe.png)
